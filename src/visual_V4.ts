...
Comment: V4 = V3 + risk bubbles with all formatting options
*/
...
module powerbi.extensibility.visual {
    ...
    export class Visual implements IVisual {
        ...
        public update(options: VisualUpdateOptions) {
            ...
            /*for(let i = 0; i < this.angularAxisFactorLevels.length; i++){
                this.angularAxisTickLabelsArray[i] = this.angularAxisFactorLevels[i];
                console.log("+++++++-----+++++", this.angularAxisTickLabelsArray[i]);
            }*/

            //console.log("+++++++-----+++++", this.angularAxisTickLabelsArray[7]);
            ...
            this.angularAxisTicksGroup
                ...
                .text(function(d, i){ /*console.log("--", d, i, global_angularAxisFactorLevels);*/ return global_angularAxisFactorLevels[i];})
                //.text("Meow")
                ;
            ...
            let bubbleSize_selection = Math.abs(Math.floor(this.settings.riskBubble.bubbleSize.value)); //default value 50%
            ...
            this.riskBubblesGroup
                ...
                .attr({
                    "transform": function(d, index){let coors = (Math.floor(width/2) + radialAxisScale(d.y) * Math.cos((1 * Math.PI * (270 + d.angle))/180)).toString() + "," + (Math.floor(height/2) + radialAxisScale(d.y) * Math.sin((1 * Math.PI * (270 + d.angle))/180)).toString(); return 'translate(' + coors + ')';},
                    //"r": 8,
                    "r": function(d, index){
