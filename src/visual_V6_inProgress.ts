...
Comment: V6 = V5 + DrillDown + complete slider
*/
...
module powerbi.extensibility.visual {
    ...
    export class Visual implements IVisual {
        ...
        private static svgContainer: d3.Selection<SVGElement>;
        private static radialAxisGroup: d3.Selection<SVGElement>;
        ...
        private static radialAxisTicksGroup : d3.Selection<SVGElement>;
        private static radialAxis : d3.Selection<SVGElement>;
        private static angularAxisGroup: d3.Selection<SVGElement>;
        private static angularAxisTicksGroup: d3.Selection<SVGElement>;

        private static parentLabelGroup: d3.Selection<SVGElement>;

        private static riskBubblesGroup: d3.Selection<SVGElement>;
        ...
        public currentValue = 0; //"2018-12-31T18:30:00.000Z";
        ...
        private static lowSize = 0;
        private static mediumSize = 0;
        private static highSize = 0;
        private static veryHighSize = 0;
        ...
        constructor(options: VisualConstructorOptions) {
            ...
            Visual.svgContainer = d3.select(options.element)
                .append("svg")
                .classed("svgContainerClass", true);
            //this.radialAxis = d3.select(options.element)
            Visual.radialAxisGroup = Visual.svgContainer
                .append("g")
                .classed("radialAxisGroupClass", true);

            Visual.radialAxisGroup.append("circle").classed("radialAxisCircle", true);
            Visual.radialAxisGroup.append("circle").classed("radialAxisCircle", true);
            Visual.radialAxisGroup.append("circle").classed("radialAxisCircle", true);
            Visual.radialAxisGroup.append("circle").classed("radialAxisCircle", true);
            Visual.radialAxisGroup.append("circle").classed("radialAxisCircle", true);

            this.textInstructionsGroup = Visual.svgContainer.append("g").classed("template_textInstructionsGroup", true);
            ...
            this.template_radialAxisGroup = Visual.svgContainer
                .append("g")
            ...
            this.slider = Visual.svgContainer.append("g").classed("slider", true);
            ...
            //this.playButtonCircle = this.svgContainer.append("circle").classed("playPauseButton", true); 
            ...
            /*this.playButton.style("position", "absolute")
                ...
                ;
            */
           Visual.radialAxisTicksGroup = Visual.svgContainer
                .append("g")
                .classed("radialAxisTickGroupClass", true)
                .attr({
                    transform: "rotate(0)" //SAFE: -90
                });
            Visual.radialAxisTicksGroup.append("text").classed("radialAxisTickClass", true);
            Visual.radialAxisTicksGroup.append("text").classed("radialAxisTickClass", true);
            Visual.radialAxisTicksGroup.append("text").classed("radialAxisTickClass", true);
            Visual.radialAxisTicksGroup.append("text").classed("radialAxisTickClass", true);

            Visual.radialAxis = Visual.svgContainer
                .append("g")
            ...
            Visual.angularAxisGroup = Visual.svgContainer
                .append("g")
                .classed("angularAxisGroupClass", true);
            
            Visual.angularAxisTicksGroup = Visual.svgContainer
                .append("g")
            ...
            Visual.parentLabelGroup = Visual.svgContainer
                .append("g")
                .classed("parentClassGroupClass", true);

            Visual.riskBubblesGroup = Visual.svgContainer
                .append("g")
            ...
            Visual.parentLabelGroup.append("g").classed("parentLabelClass", true);;
        ...
        public update(options: VisualUpdateOptions) {
            ...
            if(Visual.isAngularAxisDrilledDown){
                Visual.svgContainer.selectAll(".angularAxisLine").remove();
                Visual.svgContainer.selectAll(".angularAxisTicks").remove();
                Visual.svgContainer.selectAll(".angularAxisTickClass").remove();
                
                Visual.svgContainer.selectAll(".riskBubblesClass").remove();
                Visual.svgContainer.selectAll(".riskBubblesLabel").remove();
            ...
            Visual.lowSize <- 8 * this.bubble_size_upperlimit_factor
            Visual.mediumSize <- 12 * this.bubble_size_upperlimit_factor
            Visual.highSize <- 16 * this.bubble_size_upperlimit_factor
            Visual.veryHighSize <- 24 * this.bubble_size_upperlimit_factor
            ...
            Visual.get_dateSpecificFilterVM_thenSetFollowing_cumulativeAngularWidth_angularTickLabels_angularPosition_Array(1, radialAxis_1_weight, radialAxis_2_weight, radialAxis_3_weight, radialAxis_4_weight);
           ...
           Visual.svgContainer.selectAll(".template_textInstructionsGroup").remove();
           Visual.svgContainer.selectAll(".template_radialAxisGroupClass").remove();
            //this.svgContainer.selectAll("g").remove();

            width = options.viewport.width;
            height = options.viewport.height;

            if(Visual.settings.playAxis.show.value == true){
            ...
            .attr({
             ...
             this.moving = false;
             this.currentValue = 0; //"2018-12-31T18:30:00.000Z"; //0;
             this.targetValue = width - 100; //SAFE: 100
             ...
             let currentValue_settled = 0; //Math.round(currentValue/incrementBy) * incrementBy;
            ...
            console.log("sliderEndDate.getMonth(), sliderStartDate.getMonth(), x_playAxisScale.ticks(sliderEndDate.getMonth() - sliderStartDate.getMonth()):==>", sliderEndDate.getMonth(), sliderStartDate.getMonth(), x_playAxisScale.ticks(sliderEndDate.getMonth() - sliderStartDate.getMonth()));
             ...
             Visual.svgContainer.selectAll(".track").remove();
             Visual.svgContainer.selectAll(".track-inset").remove();
             Visual.svgContainer.selectAll(".track-overlay").remove();
             Visual.svgContainer.selectAll(".tickLabels").remove();
             Visual.svgContainer.selectAll(".tickMarks").remove();
             Visual.svgContainer.selectAll(".labelStart").remove();
             Visual.svgContainer.selectAll(".labelEnd").remove();
             Visual.svgContainer.selectAll(".handle").remove();

             Visual.svgContainer.selectAll(".playPauseButton").remove();
             Visual.svgContainer.selectAll(".playPauseTextClass").remove();
            ...
            if(Visual.settings.playAxis.show.value == true){
                ...
                this.slider.append("line")
                    ...
                    .call(
                        d3.behavior.drag().on("drag", function(d){
                            ...
                            //currentValue_settled = Math.round(currentValue/incrementBy) * incrementBy;
                            currentValue_settled = x_locationsOfTicks[ Math.round(currentValue/incrementBy) ];
                            console.log("--------riskDate FactorValue--------", Math.floor(currentValue_settled/incrementBy) + 1);
                            
                            //Visual.viewModel =    Visual.getViewModel(options); //this.viewModel;
                            ...
                            Visual.get_dateSpecificFilterVM_thenSetFollowing_cumulativeAngularWidth_angularTickLabels_angularPosition_Array(Math.floor(currentValue_settled/incrementBy) + 1, radialAxis_1_weight, radialAxis_2_weight, radialAxis_3_weight, radialAxis_4_weight);
                            Visual.set_plottingEssentialColumnsInViewModelRiskBubbles();

                            d3.select(".handle").transition().duration(200).attr("cx", currentValue_settled); //.attr("cx", x_playAxisScale( x_playAxisScale.invert(currentValue) ));
                            d3.select(".labelStart").transition().duration(200).text(formatDate(x_playAxisScale.invert(currentValue_settled) )).attr("x", x_playAxisScale( x_playAxisScale.invert(currentValue_settled) )) //.attr("transform", "translate(" + currentValue.toString() + "," + (-25) + ")")
                ...
                this.slider.insert("g", ".track-overlay")
                    ...
                    .style("font-size", Visual.settings.playAxis.tickLabelFontSize.value)
                    .style("fill", Visual.settings.playAxis.tickLabelFontColor.value)
                ...
                this.handle = this.slider.insert("circle", ".track-overlay")
                    .attr("class", "handle")
                    //.attr("cx", x_playAxisScale(new Date(2016, 1, 1)))
                    .attr("r", 9);
                ...
                */
                ...
                //let dataset = this.viewModel.riskBubbles;
                ...
                console.log("Debug: 557: currentValue, targetValue, incrementBy:==>", currentValue, targetValue, incrementBy);
                ...
                playButtonText
                    .on("click", function() {
                        ...
                        if (sliderStartDate.getTime() == sliderEndDate.getTime()){
                            ...
                            console.log("Pause clicked");
                            console.log("x/currentValue, text, moving====>", x_playAxisScale( x_playAxisScale.invert(currentValue) ), playButtonText.text(), moving);
                            playButtonText.text("Play");
                            moving = false;
                            clearInterval(timer);
                            // timer = 0;
                        } 
                        else if(playButtonText.text() == "Reset" && currentValue !=0){
                            currentValue = 0;
                            ...
                            d3.select(".labelStart").transition().duration(1000).attr("x", x_playAxisScale( x_playAxisScale.invert(currentValue) )).text(formatDate(sliderStartDate));
                            ...
                            console.log("Play clicked");
                            playButtonText.text("Pause");
                            //timer = setInterval(step, 200);  //SAFE: 100
                            timer = setInterval(
                                function(){
                                    console.log("x/currentValue, text, moving====>", x_playAxisScale( x_playAxisScale.invert(currentValue) ), playButtonText.text(), moving);
            ...
            Visual.plot_SentinelChart(options, outerMostRadialAxisRadius, width, height);
        ...
        private updateSettings(options: VisualUpdateOptions) {
            ...
            Visual.settings.axis.radialAxis.labelFontColor.value = this.fetchColorCodeFromObject(options, "radialAxis", "color", Visual.settings.axis.radialAxis.labelFontColor.default);
            Visual.settings.axis.radialAxis.labelFontSize.value = DataViewObjects.getValue(options.dataViews[0].metadata.objects, { objectName: "radialAxis", propertyName: "fontSize" }, Visual.settings.axis.radialAxis.labelFontSize.default);
            ...
            Visual.settings.axis.angularAxis.labelFontColor.value = this.fetchColorCodeFromObject(options, "angularAxis", "color", Visual.settings.axis.angularAxis.labelFontColor.default);
            Visual.settings.axis.angularAxis.labelFontSize.value = DataViewObjects.getValue(options.dataViews[0].metadata.objects, { objectName: "angularAxis", propertyName: "fontSize" }, Visual.settings.axis.angularAxis.labelFontSize.default);

            Visual.settings.parentLabel.labelFontColor.value = this.fetchColorCodeFromObject(options, "parentLabel", "color", Visual.settings.parentLabel.labelFontColor.default);
            Visual.settings.parentLabel.labelFontSize.value = DataViewObjects.getValue(options.dataViews[0].metadata.objects, { objectName: "parentLabel", propertyName: "fontSize" }, Visual.settings.parentLabel.labelFontSize.default);
            Visual.settings.parentLabel.show.value = DataViewObjects.getValue(options.dataViews[0].metadata.objects, { objectName: "parentLabel", propertyName: "show" }, Visual.settings.parentLabel.show.default);

            Visual.settings.riskBubble.greenColorLabel.value = this.fetchColorCodeFromObject(options, "riskBubble", "greenColorLabel", Visual.settings.riskBubble.greenColorLabel.default);
            Visual.settings.riskBubble.amberColorLabel.value = this.fetchColorCodeFromObject(options, "riskBubble", "amberColorLabel", Visual.settings.riskBubble.amberColorLabel.default);
            Visual.settings.riskBubble.redColorLabel.value = this.fetchColorCodeFromObject(options, "riskBubble", "redColorLabel", Visual.settings.riskBubble.redColorLabel.default);
            Visual.settings.riskBubble.labelFontSize.value = DataViewObjects.getValue(options.dataViews[0].metadata.objects, { objectName: "riskBubble", propertyName: "fontSize" }, Visual.settings.riskBubble.labelFontSize.default);
            Visual.settings.riskBubble.bubbleSize.value = DataViewObjects.getValue(options.dataViews[0].metadata.objects, { objectName: "riskBubble", propertyName: "bubbleSize" }, Visual.settings.riskBubble.bubbleSize.default);

            Visual.settings.riskBubble.greenColor.value = this.fetchColorCodeFromObject(options, "riskBubble", "greenColor", Visual.settings.riskBubble.greenColor.default);
            Visual.settings.riskBubble.amberColor.value = this.fetchColorCodeFromObject(options, "riskBubble", "amberColor", Visual.settings.riskBubble.amberColor.default);
            Visual.settings.riskBubble.redColor.value = this.fetchColorCodeFromObject(options, "riskBubble", "redColor", Visual.settings.riskBubble.redColor.default);

            Visual.settings.playAxis.tickLabelFontColor.value = this.fetchColorCodeFromObject(options, "playAxis", "color", Visual.settings.playAxis.tickLabelFontColor.default);
            Visual.settings.playAxis.tickLabelFontSize.value = DataViewObjects.getValue(options.dataViews[0].metadata.objects, { objectName: "playAxis", propertyName: "fontSize" }, Visual.settings.playAxis.tickLabelFontSize.default);
            Visual.settings.playAxis.show.value = DataViewObjects.getValue(options.dataViews[0].metadata.objects, { objectName: "playAxis", propertyName: "show" }, Visual.settings.playAxis.show.default);
            ...
            switch (propertyGroupName) {
                case "radialAxis":
                    properties.push({
                        ...
                        properties: {
                            color: Visual.settings.axis.radialAxis.labelFontColor.value,
                            fontSize: Visual.settings.axis.radialAxis.labelFontSize.value
                        },
                        selector: null
                    });
                    break;
                ...
                case "angularAxis":
                    properties.push({
                        objectName: propertyGroupName,
                        properties: {
                            color: Visual.settings.axis.angularAxis.labelFontColor.value,
                            fontSize: Visual.settings.axis.angularAxis.labelFontSize.value
                        },
                        selector: null
                    });
                    break;
                ...
                case "parentLabel":
                    properties.push({
                        objectName: propertyGroupName,
                        properties: {
                            color: Visual.settings.parentLabel.labelFontColor.value,
                            fontSize: Visual.settings.parentLabel.labelFontSize.value,
                            show: Visual.settings.parentLabel.show.value
                        },
                        selector: null
                    });
                    break;
                ...
                case "riskBubble":
                    properties.push({
                        objectName: propertyGroupName,
                        properties: {
                            greenColorLabel: Visual.settings.riskBubble.greenColorLabel.value,
                            amberColorLabel: Visual.settings.riskBubble.amberColorLabel.value,
                            redColorLabel: Visual.settings.riskBubble.redColorLabel.value,
                            fontSize: Visual.settings.riskBubble.labelFontSize.value,
                            bubbleSize: Visual.settings.riskBubble.bubbleSize.value,

                            greenColor: Visual.settings.riskBubble.greenColor.value,
                            amberColor: Visual.settings.riskBubble.amberColor.value,
                            redColor: Visual.settings.riskBubble.redColor.value
                        },
                        selector: null
                    });
                    break;
                ...
                case "playAxis":
                    properties.push({
                        objectName: propertyGroupName,
                        properties: {
                            color: Visual.settings.playAxis.tickLabelFontColor.value,
                            fontSize: Visual.settings.playAxis.tickLabelFontSize.value,
                            show: Visual.settings.playAxis.show.value
                        },
                        selector: null
                    });
                    break;
        ...
        public static get_dateSpecificFilterVM_thenSetFollowing_cumulativeAngularWidth_angularTickLabels_angularPosition_Array(riskDate_factorValue, radialAxis_1_weight, radialAxis_2_weight, radialAxis_3_weight, radialAxis_4_weight){
            console.log("riskDate_factorValue:====>", riskDate_factorValue);
            //Visual.viewModel = viewModel_wholePeriod;
            //Visual.viewModel = JSON.parse(JSON.stringify(Visual.viewModel_wholePeriod));
            Visual.viewModel.riskBubbles = Visual.viewModel.riskBubbles.filter(function f(value, index, self){ return value.factorized_riskDate == riskDate_factorValue ; }); //&& operator also works
            ...
            for (let angularAxisFactorItem_index in Visual.angularAxisFactorLevels){ //0-based angularAxisFactorItem_index is number in string type: "0", "1", "2", "3", ..
                for (let radialAxisFactorItem_index in Visual.radialAxisFactorLevels){ //0-based radialAxisFactorItem_index is number in string type: "0", "1", "2", "3", ..
                    ...
                    if(x_partition > 0){
                        ...
                        //x_vector_data <- rep(c(seq(start_CoordinateRange_x, end_CoordinateRange_x, length.out = x_partition), c(seq(start_CoordinateRange_x + each_split/2, end_CoordinateRange_x - each_split/2, length.out = x_partition - 1)  )  ), times = ceiling(y_partition/2 )) 
                        x_vector_data =  Visual.repeatArray( this.seq(Visual.start_CoordinateRange_x, Visual.end_CoordinateRange_x, x_partition).concat(this.seq(Visual.start_CoordinateRange_x + each_split/2, Visual.end_CoordinateRange_x - each_split/2, x_partition -1) ), Math.ceil(y_partition/2)  );// this.repeatArray( this.seq(this.start_CoordinateRange_x, this.end_CoordinateRange_x, x_partition).concat(this.seq(this.start_CoordinateRange_x + each_split/2, this.end_CoordinateRange_x - each_split/2, x_partition - 1))  )  ), times = ceiling(y_partition/2 )) 
        ...
        private static plot_SentinelChart(options, outerMostRadialAxisRadius, width, height){
                        //////=======START: CHART PLOTTING:======\\\\\\\////////

                        Visual.lowSize = 4
                        Visual.mediumSize = 6
                        Visual.highSize = 8
                        Visual.veryHighSize = 10
                        ...
                        let radialAxisCircle = Visual.radialAxisGroup
                        ...
                        Visual.radialAxisTicksGroup
                            ...
                            //.style("font-size", 14)
                            .style("font-size", Visual.settings.axis.radialAxis.labelFontSize.value)
                            .style("fill", Visual.settings.axis.radialAxis.labelFontColor.value)
                            .attr({
                                dx: "0.5em",
                                x: Math.abs(width / 2),
                        ...
                        */
                            ...
                            .attr({
                                ...
                                "r": function(d, index){
                                    if(d.factorized_bubbleSize == 1)
                                        return  Visual.lowSize * (bubbleSize_selection/50);
                                    else if(d.factorized_bubbleSize == 2)
                                        return Visual.mediumSize * (bubbleSize_selection/50);
                                    else if(d.factorized_bubbleSize == 3)
                                        return Visual.highSize * (bubbleSize_selection/50);
                                    else if(d.factorized_bubbleSize == 4)
                                        return Visual.veryHighSize * (bubbleSize_selection/50);
                                },
                        ...
                        .on('mouseover', function(d,i) {
                          ...
                          */
                        //////=======END: CHART PLOTTING:======\\\\\\\////////
        } //END: plot_SentinelChart() function
