...
module powerbi.extensibility.visual {
    ...
    export class Visual implements IVisual {
        ...
        private viewModel_wholePeriod: ViewModel;
        ...
        private riskDateFactorLevels = null;
        ...
        public update(options: VisualUpdateOptions) {
            ...
            console.log("^^^getUnique: riskDate^^^", typeof(this.getUnique("riskDate", this.viewModel)), this.getUnique("riskDate", this.viewModel));
            ...
            this.riskDateFactorLevels = this.getUnique("riskDate", this.viewModel);
            ...
            this.factorizeColumn("riskDate", this.viewModel, null); 

            this.viewModel_wholePeriod =    this.getViewModel(options); //this.viewModel;
            console.log("this.viewModel_wholePeriod:==>", this.viewModel_wholePeriod); 
            ...
            */          
            ...
            this.set_plottingEssentialColumnsInViewModelRiskBubbles();
            ...
            */
            ...
            .attr({
             ...
             let sliderStartDate = new Date(this.viewModel_wholePeriod.riskBubbles[0].riskDateMilliseconds); //new Date("2010-01-01");
             let sliderEndDate = new Date(this.viewModel_wholePeriod.riskBubbles[ this.viewModel_wholePeriod.riskBubbles.length - 1].riskDateMilliseconds); //new Date("2015-01-01");
             console.log("sliderStartDate, sliderEndDate:==>", sliderStartDate, sliderEndDate);
             //let margin = {top:50, right:50, bottom:0, left:50};
             //let playAxisWidth = width - margin.left - margin.right;
             //let playAxisHeight = height - margin.top - margin.bottom;
            ...
            if(this.settings.playAxis.show.value == true){
                ...
                /*var plot = this.svgContainer.append("g")
                    .attr("class", "plot")
                    .attr("transform", "translate(" + (width - 100).toString() + "," + 10 + ")");
                */
                ...
                this.slider.append("line")
                    ...
                    .call(
                        d3.behavior.drag().on("drag", function(d){
                            ...
                            console.log("-----------------", Math.floor(currentValue_settled/incrementBy));
                            this.get_dateSpecificFilterVM_thenSetFollowing_cumulativeAngularWidth_angularTickLabels_angularPosition_Array(Math.ceil(currentValue_settled/incrementBy), radialAxis_1_weight, radialAxis_2_weight, radialAxis_3_weight, radialAxis_4_weight);
                            this.set_plottingEssentialColumnsInViewModelRiskBubbles();
                ...
                */
                ...
                /*function step() {  
                    ...
                    update_playAxis(x_playAxisScale.invert(this.currentValue));
                ...
                */
                ...
                /*function drawPlot(data) {
                    ...
                    .data(data);
                    console.log("data from drawPlot:==>", data);
                    // if filtered dataset has more circles than already existing, transition new ones in
                    locations.enter()
                    .append("circle")
                    .attr("class", "location")
                    .attr("cx", function(d) { return x_playAxisScale(d.date); })
                    .attr("cy", height/2)
        ...
        public  get_dateSpecificFilterVM_thenSetFollowing_cumulativeAngularWidth_angularTickLabels_angularPosition_Array(riskDate_factorValue, radialAxis_1_weight, radialAxis_2_weight, radialAxis_3_weight, radialAxis_4_weight){
            this.viewModel.riskBubbles = this.viewModel.riskBubbles.filter(function f(value, index, self){ return value.factorized_riskDate == riskDate_factorValue ; }); //&& operator also works
        ...
        public set_plottingEssentialColumnsInViewModelRiskBubbles(){
            this.start_CoordinateRange_x = this.offset;
            this.end_CoordinateRange_x = 1 - this.offset;
            this.start_CoordinateRange_y = this.offset;
            this.end_CoordinateRange_y = 1 - this.offset;
            ...
            console.log("--------------START: Inside function: set_plottingEssentialColumnsInViewModelRiskBubbles-------------------");
            console.log("**this.viewModel:==>", this.viewModel);
            console.log("**this.sentinelChartTitle", this.sentinelChartTitle);
            console.log("**this.angularWeight_Array:==>", this.angularWeight_Array);
            console.log("**this.angularTickLabels_angularPosition_Array:==>", this.angularTickLabels_angularPosition_Array);
