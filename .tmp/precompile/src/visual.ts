...
module powerbi.extensibility.visual.sentinelChartBFDC788B8CFF47158A4F9BFB660DE97D  {
    "use strict";
    interface Risk {
        parentLabel: string;
        angularAxis: string;
        ...
        riskDate_firstOfMonth_Milliseconds: number;
    ...
    export class Visual implements IVisual {
        ...
        public update(options: VisualUpdateOptions) {
            ...
            */
            ...
            .attr({
             ...
             let sliderStartDate = new Date(Visual.viewModel_wholePeriod.riskBubbles[0].riskDate_firstOfMonth_Milliseconds); //new Date("2010-01-01");
             let sliderEndDate = new Date(Visual.viewModel_wholePeriod.riskBubbles[ Visual.viewModel_wholePeriod.riskBubbles.length - 1].riskDate_firstOfMonth_Milliseconds); //new Date("2015-01-01");
                ...
                this.slider.append("line")
                    ...
                    .call(
                        d3.behavior.drag().on("drag", function(d){
                            ...
                            if(d3.select(".playPauseTextClass").text() == "Reset" && currentValue != targetValue){ //CASE: if Button text is already "Reset" and handle dragged to some other location than last tick
            ...
            let angularAxisTicks_text_line = this.angularAxisTicksGroup
        ...
        private static getViewModel(options: VisualUpdateOptions): ViewModel{
            ...
            */
            ...
            let dateSeparatorCharacter: string = categories[7].values[0].toString().indexOf('-') >= 0 ? "-" : "/";
            for (let i = 0, len = Math.max(categories[0].values.length, categories[1].values.length, categories[2].values.length, categories[3].values.length, categories[4].values.length, categories[5].values.length); i < len; i++) {
                ...
                viewModel.riskBubbles.push({
                    ...
                    */
                    ...
                    parentLabel: <string>categories[0].values[i] == null ? "Blank": <string>categories[0].values[i],
                    angularAxis: <string>categories[1].values[i].toString().trim() == null ? "Blank" : <string>categories[1].values[i].toString().trim(),  
                    radialAxis: <string>categories[2].values[i] == null ? "Blank" : <string>categories[2].values[i],
                    bubbleSize: <string>categories[3].values[i] == null ? "Blank" : <string>categories[3].values[i],
                    bubbleColor: <string>categories[4].values[i] == null ? "Blank" : <string>categories[4].values[i],
                    bubbleLabel: <string>categories[5].values[i] == null ? "Blank" : <string>categories[5].values[i],
                    riskOwner: <string>categories[6].values[i] == null ? "Blank" : <string>categories[6].values[i].toString().replace(/[^\x00-\x7F]/g, "").trim(),
                    ...
                    riskDate: <string>categories[7].values[i] == null ? "Blank" : <string>categories[7].values[i],  //Date is in d-m-yyyy format. Example: 1st March 2019 as: 1-3-2019
            ...
            viewModel.riskBubbles.sort((a,b) => a.riskDate_firstOfMonth_Milliseconds - b.riskDate_firstOfMonth_Milliseconds);
            ...
            for (let i = 0, len = Math.max(categories[0].values.length, categories[1].values.length, categories[2].values.length, categories[3].values.length, categories[4].values.length, categories[5].values.length); i < len; i++) {
                ...
                if(<string>categories[1].values[i] == angularAxisSelected){
                    viewModel.riskBubbles.push({
                       ...
                       //.replace(/[\W_]+/g," ") //replaces all non-alphanumeric_space with nothing
                       //.replace(/[^\x00-\x7F]/g, ""); ////replaces all non-ascii(0-127 range in hex: 00 - 7F) with nothing
                        parentLabel: <string>categories[1].values[i] == null ? "Blank" : <string>categories[1].values[i],
                        angularAxis: <string>categories[6].values[i] == null ? "Blank" : <string>categories[6].values[i].toString().replace(/[^\x00-\x7F]/g, "").trim(),  
                        radialAxis: <string>categories[2].values[i] == null ? "Blank" : <string>categories[2].values[i],
                        bubbleSize: <string>categories[3].values[i] == null ? "Blank" : <string>categories[3].values[i],
                        bubbleColor: <string>categories[4].values[i] == null ? "Blank" : <string>categories[4].values[i],
                        bubbleLabel: <string>categories[5].values[i] == null ? "Blank" : <string>categories[5].values[i],
                        riskOwner: <string>categories[0].values[i] == null ? "Blank" : <string>categories[0].values[i].toString().trim(),
                        //SAFE: riskDate: <string>categories[7].values[i] == null ? "Blank" : <string>("1" + categories[7].values[i].toString().substring(1)),
                        riskDate: <string>categories[7].values[i] == null ? "Blank" : <string>categories[7].values[i],
                       ...
                       */
                        ...
                        tooltips: [
                            ...
                            {
                            displayName: riskDateColumnName,
                            value: <string>categories[7].values[i] //SAFE: <string>categories[7].values[i]
                            }
                        ]
                    });
                }
