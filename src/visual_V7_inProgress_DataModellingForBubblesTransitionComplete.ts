    ...
    export class Visual implements IVisual {
        ...
        public update(options: VisualUpdateOptions) {
            ...
            if(Visual.getBubblesDetailsObject.length != Visual.viewModel_wholePeriod.riskBubbles.length){
                ...
                for(let i = 0; i < Visual.riskDateFactorLevels.length; i++){
                    ...
                    for(var obj in Visual.viewModel.riskBubbles){ //obj is index number of riskBubble[] array
                        ...
                        Visual.bubblesDetailsObject[uniqueIndexForConsolidation][particularRisk["bubbleLabel"]]["angle" + stringOf_RiskDateSelectedFactorValue] = particularRisk["angle"];
                        Visual.bubblesDetailsObject[uniqueIndexForConsolidation][particularRisk["bubbleLabel"]]["x" + stringOf_RiskDateSelectedFactorValue] = particularRisk["x"];
                        Visual.bubblesDetailsObject[uniqueIndexForConsolidation][particularRisk["bubbleLabel"]]["y" + stringOf_RiskDateSelectedFactorValue] = particularRisk["y"];
                        Visual.bubblesDetailsObject[uniqueIndexForConsolidation][particularRisk["bubbleLabel"]]["factorized_bubbleColor" + stringOf_RiskDateSelectedFactorValue] = particularRisk["factorized_bubbleColor"];
                        Visual.bubblesDetailsObject[uniqueIndexForConsolidation][particularRisk["bubbleLabel"]]["factorized_bubbleSize" + stringOf_RiskDateSelectedFactorValue] = particularRisk["factorized_bubbleSize"];
                        Visual.bubblesDetailsObject[uniqueIndexForConsolidation][particularRisk["bubbleLabel"]]["factorized_riskDate" + stringOf_RiskDateSelectedFactorValue] = particularRisk["factorized_riskDate"];
                        Visual.bubblesDetailsObject[uniqueIndexForConsolidation][particularRisk["bubbleLabel"]]["bubbleSize" + stringOf_RiskDateSelectedFactorValue] = particularRisk["bubbleSize"];
                        Visual.bubblesDetailsObject[uniqueIndexForConsolidation][particularRisk["bubbleLabel"]]["bubbleLabel" + stringOf_RiskDateSelectedFactorValue] = particularRisk["bubbleLabel"];
                ...
                for(var obj in Visual.bubblesDetailsObject[uniqueIndexForConsolidation]){ //obj is name of keys
                    ...
                    Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["factorized_bubbleColor" + stringOf_RiskDateSelectedFactorValue] = 0;
                    Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["factorized_bubbleSize" + stringOf_RiskDateSelectedFactorValue] = 0;
                    Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["factorized_riskDate" + stringOf_RiskDateSelectedFactorValue] = 0;
                    Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["bubbleSize" + stringOf_RiskDateSelectedFactorValue] = 0;
                    Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["bubbleLabel" + stringOf_RiskDateSelectedFactorValue] = 0;
                    ...
                    for(let i = 1; i <= Visual.riskDateFactorLevels.length; i++){
                        ...
                        if(Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["angle_" + i.toString() ] == null){  
                            console.log("Missing:==>(bubbleLabel, riskDateFactor)", obj, i);
                            ...
                            Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["factorized_bubbleColor_" + i.toString()] = 0;
                            Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["factorized_bubbleSize_" + i.toString()] = 0;
                            Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["factorized_riskDate_" + i.toString()] = 0;
                            Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["bubbleSize_" + i.toString()] = 0;
                            Visual.bubblesDetailsObject[uniqueIndexForConsolidation][obj]["bubbleLabel_" + i.toString()] = 0;
                        }
                    }
                }  
                //console.log("^^^^^^COMPLETE VisualbubblesDetailsObject^^^^", Visual.bubblesDetailsObject);
            }
            Visual.riskDateSelectedFactorValue = initial_riskDateSelectedFactorValue;
            
            for(let i = 0; i < 7; i++){
                console.log(i, Object.keys(Visual.bubblesDetailsObject[i]).length);
            }
            console.log("uniqueIndexForConsolidation", Object.keys(Visual.bubblesDetailsObject[uniqueIndexForConsolidation]).length);
            console.log("^^^^^^COMPLETE VisualbubblesDetailsObject^^^^", Visual.bubblesDetailsObject);
            ...
            */
            ...
            /*SAFE: WORKING: RISK BUBBLE CIRCLES
            ...
            this.riskBubblesGroup
                .selectAll(".riskBubbles")
                .data(Visual.viewModel.riskBubbles)
                //.data(Visual.bubblesDetailsObject)
                .enter()
                .append("circle")
                .classed("riskBubblesClass", true)
                .attr({
